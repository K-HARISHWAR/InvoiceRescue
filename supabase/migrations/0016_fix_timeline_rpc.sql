-- 0016_fix_timeline_rpc.sql

-- Replaces the RPC to use SECURITY INVOKER (default) and rely on RLS,
-- rather than manual auth checks that can raise 400 errors.
...
BEGIN
    -- RLS will automatically ensure the user only sees data they have access to.
